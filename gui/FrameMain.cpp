// -*- C++ -*- generated by wxGlade 0.6.1 on Thu Jan 15 19:57:32 2009
    ...
    wxFrame(parent, id, title, pos, size, wxDEFAULT_FRAME_STYLE)
{
    ...
    sizer_wBox_staticbox = new wxStaticBox(panel_wborder, -1, _("Available VNC Servers"));
    frame_main_menubar = new wxMenuBar();
    wxMenu* wxglade_tmp_menu_1 = new wxMenu();
    wxglade_tmp_menu_1->Append(wxID_EXIT, wxEmptyString, _("Exit CollabTool."), wxITEM_NORMAL);
    frame_main_menubar->Append(wxglade_tmp_menu_1, _("&File"));
    wxMenu* wxglade_tmp_menu_2 = new wxMenu();
    wxglade_tmp_menu_2->Append(wxID_ADD, _("&Share Window"), _("Beam a window to the server."), wxITEM_NORMAL);
    wxglade_tmp_menu_2->Append(wxID_REMOVE, _("&Stop Sharing Window"), _("Stop Window Sharing."), wxITEM_NORMAL);
    ...
    wxglade_tmp_menu_3->Append(wxID_HELP, _("&Contents"), _("Show CollabTool Help."), wxITEM_NORMAL);
    ...
    const wxString list_box_services_choices[] = {
...
BEGIN_EVENT_TABLE(FrameMain, wxFrame)
    ...
    EVT_MENU(wxID_ADD, FrameMain::edit_share)
    EVT_MENU(wxID_REMOVE, FrameMain::edit_endshare)
...
void FrameMain::edit_share(wxCommandEvent &event)
{
    event.Skip();
    wxLogDebug(wxT("Event handler (FrameMain::edit_share) not implemented yet")); //notify the user that he hasn't implemented the event handler yet
}


void FrameMain::edit_endshare(wxCommandEvent &event)
{
    event.Skip();
    wxLogDebug(wxT("Event handler (FrameMain::edit_endshare) not implemented yet")); //notify the user that he hasn't implemented the event handler yet
}
